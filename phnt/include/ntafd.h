...
//
// Sockets can use two modes of transport: TLI and TDI. The mode is selected based on whether the caller
// specifies the transport device at socket creation. No device means TLI, which is the most common choice.
//
...
//  - TDI sockets use non-TL structures and TDI_ADDRESS_INFO for addresses.
//
...
#define AFD_ADDRESS_LIST_QUERY          44 // in: USHORT (TDI_ADDRESS_TYPE_*); out: TRANSPORT_ADDRESS
