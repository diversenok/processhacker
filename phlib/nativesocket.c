    ...
    )
{
    ...
    volumeName.Length = (WORD)Buffer.VolumeName.DeviceNameLength;
    volumeName.MaximumLength = (WORD)Buffer.VolumeName.DeviceNameLength;
    ...
    )
{
    ...
    else if (Address->ss_family == AF_BTH)
    {
        ...
        *AddressString = PhFormatString(
            ...
            (BYTE)(address->btAddr >> 40),
            (BYTE)(address->btAddr >> 32),
            (BYTE)(address->btAddr >> 24),
            (BYTE)(address->btAddr >> 16),
            (BYTE)(address->btAddr >> 8),
            (BYTE)(address->btAddr),
            address->port
        );
